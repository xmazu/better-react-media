...
export const activeSlideStatus = (
  status: SlideStatus
): `active-slide-${SlideStatus}` => `active-slide-${status}`;
...
export const ACTIVE_SLIDE_ERROR = activeSlideStatus(
  SLIDE_STATUS_ERROR
) as 'active-slide-error';
export const ACTIVE_SLIDE_COMPLETE = activeSlideStatus(
  SLIDE_STATUS_COMPLETE
) as 'active-slide-complete';

/** Public root attribute for CSS variable theming */
export const DATA_LIGHTBOX = 'data-lightbox';
