...
export interface TimeoutsContextType {
  setTimeout: (fn: () => void, delay?: number) => number;
  clearTimeout: (id?: number) => void;
}

export const TimeoutsContext = React.createContext<TimeoutsContextType | null>(
  null
);

export const useTimeouts = makeUseContext(
  'useTimeouts',
  'TimeoutsContext',
  TimeoutsContext
);
...
export function TimeoutsProvider({ children }: React.PropsWithChildren) {
  ...
  return (
    <TimeoutsContext.Provider value={context}>
      {children}
