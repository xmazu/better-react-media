...
import type { LightboxExternalProps, SlideshowRef } from '../../src/index';
import { isImageSlide } from '../../src/index';
import { Slideshow } from '../../src/plugins/index';
import { expectToContainButton, lightbox } from "../test-utils";
...
describe("Slideshow", () => {
  ...
  it("auto plays slides", () => {
    ...
    renderLightbox({
      ...
      on: { slideshowStart, slideshowStop, view },
      render: {
        slide: ({ slide }) =>
          isImageSlide(slide)
            ? React.createElement("div", null, slide.src)
            : null,
      },
